...
const App = () => {
   ...
   const jobOpenings = [
    {
      brandLogo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeJG171pMu9VTeNIjsIA8d5_-Sy8MvUBmZEA&s",
      companyName: "Meta",
    ...
    <div className='parent'>
        {jobOpenings.map(function(elem,idx){
         return <div key={idx}>
          ...
          post={elem.post} tag1={elem.tag1} brandlogo={elem.brandLogo} 
          pay={elem.pay} tag2={elem.tag2}  />
         </div>
        })}
    </div>
